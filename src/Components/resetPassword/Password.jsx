...
function changeConfirmPassword({target}){
    ...
    if(password.password!==target.value){
     ...
     const handleForm=(e)=> { 
        ...
        e.preventDefault()
        setLoading(true)
        Axios({method:'post',url:'http://localhost:5000/forgotPassword',
     ...
     const handleVerification=(e)=> {
        ...
        e.preventDefault()
        setLoading(true)
        Axios({method:'post',url:'http://localhost:5000/verify_opt',
      ...
      const handleReset=(e)=> {
        ...
        if(!confirmpassword.invalid){
            ...
            setLoading(true)
        Axios({method:'post',url:'http://localhost:5000/resetPassword',
